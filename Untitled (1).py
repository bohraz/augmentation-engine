...
transforms1 = [
    transforms.ColorJitter(brightness=(0.25,1.75), contrast=(0.25,2.75), saturation=(0.25,2.25)),
...
train_data_loader = FilamentDataLoader(dataset = train_dataset,batch_size = 99 , filament_ratio = (1, 1, 1),n_batchs = 20, 
                                 transforms = transforms1, image_dim = 224)
validate_data_loader = FilamentDataLoader(dataset = validate_dataset,batch_size = 9 , filament_ratio = (1, 1, 1),n_batchs = 3, 
                                 transforms = transforms1, image_dim = 224)
...
optimizer = optim.Adam(model1.fc.parameters(), lr=0.01)
#SGD
model1.to(device)
...
#                                                            transforms=transforms1, image_dim=224)
#         validate_data_loader = FilamentDataLoader(dataset=validate_dataset, batch_size=30, filament_ratio=(1, 1, 1),
